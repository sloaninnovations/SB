 ...
 * The Ooyala Web Uploader (extract in sites/all/libraries):
   https://github.com/ooyala/ooyala-web-uploader/tarball/master

Note that the Services module is only required from an API level. If your site
does not use Services for any other purposes, the Services UI will not be
enabled.
