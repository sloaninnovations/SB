...
<div id="<?php print $player_id; ?>" class="ooyala_shared_player">
  <div id="<?php print $player_id; ?>-wrapper">
    <script src="http://player.ooyala.com/player.js?callback=receiveOoyalaEvent&playerId=<?php print $player_id; ?>-player&width=<?php print $width; ?>&height=<?php print $height; ?>&embedCode=<?php print $first_embed_code; ?>"></script>
  </div>
